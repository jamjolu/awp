 ...
 function editOptions () {
	showElement(document.getElementById('options'));
			...
			function setPageData(){
				...
				document.getElementById("bigPic").src = document.getElementById("pgBigPic").value;
				document.getElementById("bigPic").alt = document.getElementById("pgBigPicAlt").value;
				document.getElementById("mainText").innerHTML = document.getElementById("pgMainText").value;
			}
			...
			function getPageData(){
				...
				document.getElementById("pgBigPic").value = document.getElementById("bigPic").getAttribute('src');
				document.getElementById("pgBigPicAlt").value = document.getElementById("bigPic").getAttribute('alt');
				document.getElementById("pgMainText").value = document.getElementById("mainText").innerHTML;
			}