...
var pageElmt = document.getElementById("thisPage");
	scanActors.elmts =  pageElmt.getElementsByClassName("actor");
var daBtnsElmt = document.getElementById("daBtns");
	q4Actors.elmts = daBtnsElmt.getElementsByClassName("actor");
var ytActorsElmt = document.getElementById("yt_strip");
	ytActors.elmts = ytActorsElmt.getElementsByClassName("actor");
	scanActors.currIx = 0;
