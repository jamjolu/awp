	...
	function getFontSettings() {
	 let fntSzIx = localStorage.getItem("actorQP.fntSzIx");
	 let fntCaseIx = localStorage.getItem("actorQP.fntCaseIx");
	 let fntFamIx = localStorage.getItem("actorQP.fntFamIx");
	 if (fntSzIx >= 0){
